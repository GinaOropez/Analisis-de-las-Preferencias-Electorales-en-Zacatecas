# -*- coding: utf-8 -*-
"""análisis_de_las_preferencias_electorales_en_el_zacatecas.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oNbyLmCv6w4yyVIqWT6i_UkKGUKirIK1
"""
...
def calcular_entropia(probabilidades):
    ...
    """
    H'(μ) = - Σ [ p * log2(p) ] / log2(|Ω|)
    """

    # Número de estados posibles
    total_estados = len(probabilidades)
    ...
    entropia = -(
        probabilidades * np.log2(probabilidades)
    ) / np.log2(total_estados)

    # Reemplazar NaN por 0
    return entropia.fillna(0)
